...
function HeroSection() {
  return (
    <section className="relative min-h-[70vh] flex items-center pt-20 overflow-hidden bg-background">
      {/* Background */}
      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight mb-6">
            <span className="text-primary">JBird Bike Shop</span>
          </h1>

          <div className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 space-y-3">
            <p className="font-semibold">
              <a href="/repairs" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
                Bicycles & eBikes Repair & Maintenance
              </a>
            </p>
            <p className="font-semibold">
              <a href="/ebikes" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
                Quality, Affordable eBike Sales
              </a>
            </p>
            <p className="font-semibold">
              <a href="/ebikes" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
            ...
            <p className="font-semibold">
              <a href="/assembly" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
                Buying an eBike Online? We Assemble it for You!
              </a>
            </p>
            <p className="font-semibold">
              <a href="/nola-incentive" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
                Official Retailer of the NOLA eBike Incentive Program
              </a>
            </p>
          </div>
...
function EBikesSection() {
  return (
    <section id="ebikes" className="section-padding bg-gradient-to-br from-primary/5 to-secondary/5">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            <a href="/ebike-sales" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
              Quality, Affordable eBikes
            </a>
          </h2>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center justify-center gap-3">
              ...
              <p className="text-xl font-semibold text-foreground">New ebikes, Fully Built</p>
            </div>
            <div className="flex items-center justify-center gap-3">
              <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
              <p className="text-xl font-semibold text-foreground">Our Exclusive 10-Point Check</p>
            </div>
            <div className="flex items-center justify-center gap-3">
              <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
              <p className="text-xl font-semibold text-foreground">Many Exclusive JBird Extra Features Included</p>
            </div>
            <div className="flex items-center justify-center gap-3">
              <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
              <p className="text-xl font-semibold text-foreground">Professional Service & Maintenance</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-6">Come Test-Ride Your Next eBike!</h3>
          <Button size="lg">
            Find Out More
            <ArrowRight className="w-4 h-4 ml-2" />
          </Button>
...
function BikeCarouselSection() {
  return (
    <section className="section-padding bg-secondary/10">
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Test-Ride These Bikes Today</h2>
          <BikeCarousel />
        </div>
      </div>
    </section>
...
function RepairsSection() {
  return (
    <section id="repairs" className="section-padding bg-primary/5">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h3 className="text-3xl md:text-4xl font-bold mb-8">
            We Fix What Others Don't!
          </h3>

          <div className="bg-card p-8 rounded-2xl border border-border mb-8">
            <h4 className="text-2xl md:text-3xl font-bold mb-6">Free Diagnostic Included</h4>
            <div className="space-y-4">
              <div className="flex items-center justify-center gap-3">
                <DollarSign className="w-6 h-6 text-secondary shrink-0" />
                <p className="text-xl md:text-2xl font-semibold">Single Repair: $65 + parts</p>
              </div>
              <p className="text-base text-muted-foreground">Flat fee for any single repair</p>

              <div className="flex items-center justify-center gap-3 mt-6">
                <DollarSign className="w-6 h-6 text-secondary shrink-0" />
                <p className="text-xl md:text-2xl font-semibold">Flats: $30 + parts</p>
              </div>
              <p className="text-base text-muted-foreground">Quick turnaround on flat repairs</p>
            </div>
          </div>
...
function AssemblySection() {
  return (
    <section id="assembly" className="section-padding bg-secondary/15">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            eBike Assembly
          ...
          <p className="text-2xl md:text-3xl font-bold mb-6">
            Get a Professional Assembly
          </p>

          <div className="bg-card p-8 rounded-2xl border border-border mb-8">
            <h3 className="text-2xl md:text-3xl font-bold mb-6">We Don't Just Assemble It, We Build It</h3>
            <ul className="space-y-4">
              <li className="flex items-center justify-center gap-3">
                <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                <span className="text-lg md:text-xl">Complete professional assembly</span>
              </li>
              <li className="flex items-center justify-center gap-3">
                <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                <span className="text-lg md:text-xl">Safety inspection & testing</span>
              </li>
              <li className="flex items-center justify-center gap-3">
                <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                <span className="text-lg md:text-xl">Proper torque specifications</span>
              </li>
              <li className="flex items-center justify-center gap-3">
                <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                <span className="text-lg md:text-xl">Test ride before pickup</span>
              </li>
            </ul>
          </div>

          <div className="mb-6">
            <a href="/assembly" className="text-xl md:text-2xl font-bold text-primary hover:underline underline-offset-4 block mb-6">
              JBird Bikes Exclusive Built
            </a>
          </div>
...
function NOLASection() {
  return (
    <section id="nola" className="section-padding bg-gradient-to-br from-primary/10 to-secondary/10">
      <div className="container">
        <div className="max-w-4xl mx-auto">
