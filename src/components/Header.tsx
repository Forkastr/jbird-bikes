  ...
  return (
    <>
                  ...
                  {BRANDS.map((brand) => (
                    <a
                      ...
                      style={{
                        ...
                        padding: '0.6rem 1rem',
                        fontSize: '0.8rem',
                        fontWeight: brand.name === 'All Bikes' ? 700 : 500,
                        color: brand.name === 'All Bikes' ? '#2E7D32' : '#444',
                        textDecoration: 'none',
                        textTransform: 'uppercase' as const,
                        letterSpacing: '0.05em',
                        borderBottom: brand.name === 'All Bikes' ? '1px solid #e5e7eb' : 'none',
      ...
      <div style={{
        ...
        <a href="https://square.site/book/your-link" target="_blank" style={{ ...testRideBtn, marginTop: '1rem', display: 'block', textAlign: 'center' as const }}>BOOK TEST-RIDE</a>
      </div>
