...
export default function TestRideBanner() {
  return (
    <section style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem 5rem' }}>
      <div style={{ backgroundColor: 'var(--accent-yellow)', border: '4px solid var(--primary-green)', borderRadius: '1.5rem', padding: '3rem', display: 'flex', flexWrap: 'wrap' as const, alignItems: 'center', justifyContent: 'space-between', gap: '2rem' }}>
        <div>
