...
export const metadata: Metadata = {
  title: 'Retrospec eBikes New Orleans | Authorized Dealer — JBird Bikes',
  description: 'Buy Retrospec eBikes fully assembled in New Orleans. Authorized dealer on the Lafitte Greenway. Test ride today. Professional 21-point assembly included.',
  keywords: ['Retrospec eBike New Orleans', 'Retrospec dealer New Orleans', 'Retrospec eBike NOLA', 'buy Retrospec eBike assembled New Orleans', 'Retrospec authorized dealer Louisiana'],
  openGraph: { title: 'Retrospec eBikes New Orleans | JBird Bikes', description: 'Come test-ride a Retrospec eBike on the Lafitte Greenway. Professional assembly included.', url: 'https://jbirdbikes.com/retrospec-ebikes-new-orleans', images: [{ url: '/hero-bike.jpg', width: 1200, height: 630 }] },
};

export default function RetrospecPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'ItemList', name: 'Retrospec eBikes at JBird Bikes New Orleans', url: 'https://jbirdbikes.com/retrospec-ebikes-new-orleans' }) }} />
      ...
      <div className="brand-hero">
        <div className="brand-hero-inner">
          ...
          <h1>Retrospec eBikes <span>In New Orleans</span></h1>
          <p>Come test-ride a Retrospec eBike on the Lafitte Greenway. Every bike comes fully assembled with our JBird Special — a professional 21-point safety inspection, No-Flat tire treatment, and a 60-day shakeout tune-up. Built for NOLA streets. Built to last.</p>
      ...
      <div className="brand-about">
        <div className="brand-about-text">
          <h2>About Retrospec</h2>
          <p>Retrospec is a Los Angeles-based brand known for making quality bikes and eBikes accessible to everyday riders. Founded with a mission to get more people on bikes, they combine clean design with reliable components at prices that make sense.</p>
          <p>Their eBike lineup covers commuters, cruisers, and folding models — all built for comfort and durability. At JBird Bikes, we carry their best models fully assembled and ready for New Orleans streets.</p>
        </div>
        <div className="brand-stat-box">
          <div className="brand-stat"><div className="brand-stat-num">LA</div><div className="brand-stat-label">Based</div></div>
          <div className="brand-stat"><div className="brand-stat-num">500+</div><div className="brand-stat-label">5-Star Reviews</div></div>
          <div className="brand-stat"><div className="brand-stat-num">2yr</div><div className="brand-stat-label">Warranty</div></div>
          <div className="brand-stat"><div className="brand-stat-num">2010</div><div className="brand-stat-label">Founded</div></div>
        </div>
      </div>
      ...
      <div className="brand-cta">
        ...
        <p>Visit us on the Lafitte Greenway. We're here to help you find the right Retrospec eBike for NOLA.</p>
