...
export const metadata: Metadata = {
  title: 'Aventon eBikes New Orleans | Authorized Dealer — JBird Bikes',
  description: 'Buy Aventon eBikes fully assembled in New Orleans. Authorized dealer on the Lafitte Greenway. Test ride today. Professional 21-point assembly included.',
  keywords: [
    'Aventon eBike New Orleans',
    'Aventon dealer New Orleans',
    'Aventon eBike NOLA',
    'buy Aventon eBike assembled New Orleans',
    'Aventon authorized dealer Louisiana',
    'Aventon bike shop Lafitte Greenway',
  ],
  openGraph: {
    title: 'Aventon eBikes New Orleans | JBird Bikes — Authorized Dealer',
    description: 'Come test-ride an Aventon eBike on the Lafitte Greenway. Every bike comes with our JBird Special Assembly — 21-point safety check, No-Flat treatment, 60-day tune-up.',
    url: 'https://jbirdbikes.com/aventon-ebikes-new-orleans',
    images: [{ url: '/hero-bike.jpg', width: 1200, height: 630 }],
  },
};

export default function AventonPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'ItemList',
            name: 'Aventon eBikes at JBird Bikes New Orleans',
            description: 'Authorized Aventon eBike dealer in New Orleans. Professional assembly included.',
            url: 'https://jbirdbikes.com/aventon-ebikes-new-orleans',
          }),
        }}
      />
      ...
      <div className="brand-hero">
        <div className="brand-hero-inner">
          ...
          <h1>Aventon eBikes <span>In New Orleans</span></h1>
          <p>Come test-ride an Aventon eBike on the Lafitte Greenway. Every bike comes fully assembled with our JBird Special — a professional 21-point safety inspection, No-Flat tire treatment, and a 60-day shakeout tune-up. Built for NOLA streets. Built to last.</p>
      ...
      <div className="brand-about">
        <div className="brand-about-text">
          <h2>About Aventon</h2>
          <p>Founded in California in 2013, Aventon started as a fixed-gear bicycle brand before pivoting to eBikes in 2018. Today they are one of the most recognized eBike names in North America, with over 1,800 retail partners across the continent.</p>
          <p>Aventon owns its own manufacturing facility in China, giving them direct control over quality at every step. Their lineup spans commuters, cargo, folding, and off-road models — all engineered for performance and built to last.</p>
        </div>
        <div className="brand-stat-box">
          <div className="brand-stat"><div className="brand-stat-num">1800+</div><div className="brand-stat-label">Retail Partners</div></div>
          <div className="brand-stat"><div className="brand-stat-num">$100M</div><div className="brand-stat-label">Revenue</div></div>
          <div className="brand-stat"><div className="brand-stat-num">2yr</div><div className="brand-stat-label">Warranty</div></div>
          <div className="brand-stat"><div className="brand-stat-num">2013</div><div className="brand-stat-label">Founded</div></div>
        </div>
      </div>
      ...
      <div className="brand-cta">
        ...
        <p>Visit us on the Lafitte Greenway. We're here to help you find the right Aventon eBike for NOLA.</p>
