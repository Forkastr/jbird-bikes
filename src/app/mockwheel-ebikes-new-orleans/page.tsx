...
export const metadata: Metadata = {
  title: 'Mockwheel eBikes New Orleans | Authorized Dealer — JBird Bikes',
  description: 'Buy Mockwheel eBikes fully assembled in New Orleans. Authorized dealer on the Lafitte Greenway. Test ride today. Professional 21-point assembly included.',
  keywords: ['Mockwheel eBike New Orleans', 'Mockwheel dealer New Orleans', 'Mockwheel eBike NOLA', 'buy Mockwheel eBike assembled New Orleans', 'Mockwheel authorized dealer Louisiana'],
  openGraph: { title: 'Mockwheel eBikes New Orleans | JBird Bikes', description: 'Come test-ride a Mockwheel eBike on the Lafitte Greenway. Professional assembly included.', url: 'https://jbirdbikes.com/mockwheel-ebikes-new-orleans', images: [{ url: '/hero-bike.jpg', width: 1200, height: 630 }] },
};

export default function MockwheelPage() {
  return (
    <>
      ...
      <div className="brand-hero">
        <div className="brand-hero-inner">
          ...
          <h1>Mockwheel eBikes <span>In New Orleans</span></h1>
          <p>Come test-ride a Mockwheel eBike on the Lafitte Greenway. Every bike comes fully assembled with our JBird Special — a professional 21-point safety inspection, No-Flat tire treatment, and a 60-day shakeout tune-up. Built for NOLA streets. Built to last.</p>
      ...
      <div className="brand-about">
        <div className="brand-about-text">
          <h2>About Mockwheel</h2>
          <p>Mockwheel is an emerging eBike brand focused on delivering high-performance electric bikes at competitive prices. Their models are designed for urban riders who demand reliability, style, and power without the premium price tag.</p>
          <p>At JBird Bikes, we handpick only the models we believe in. Every Mockwheel we sell comes fully assembled, safety-inspected, and tuned for the streets of New Orleans.</p>
        </div>
        <div className="brand-stat-box">
          ...
          <div className="brand-stat"><div className="brand-stat-num">500W+</div><div className="brand-stat-label">Motor Power</div></div>
          <div className="brand-stat"><div className="brand-stat-num">2yr</div><div className="brand-stat-label">Warranty</div></div>
          <div className="brand-stat"><div className="brand-stat-num">$350</div><div className="brand-stat-label">Starting Price</div></div>
        </div>
      </div>
      ...
      <div className="brand-cta">
        ...
        <p>Visit us on the Lafitte Greenway. We're here to help you find the right Mockwheel eBike for NOLA.</p>
